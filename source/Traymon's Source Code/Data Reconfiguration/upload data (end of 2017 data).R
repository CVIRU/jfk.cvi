...
StudyGroupIDs = Master[Master[, "DaysId"] == 3 & 
                         Master[, "Group"] == "Study Group", "ID"]
...
ControlGroupIDs = Master[Master[, "DaysId"] == 3 & 
                           Master[, "Group"] == "Control Group", "ID"]
...
# count the number of patients never assigned to a group
no.group.num = length(unique(Master[, "ID"])) - length(Master[Master[ ,"DaysId"] == 3, "DaysId"])
