...
#         into new csv files; 7th round of data received                           #
####################################################################################

# set the working directory to retreive the data
setwd("F:/For RWJCVI - 2018Aug10_CatNo1-958plusDeceased")

# upload data
Demdata = read.csv("Demographics_08102018.csv")
Mesdata = read.csv("Measurement_08102018.csv")
MedHisdata = read.csv("MedicalHist_08102018.csv")
...
# As of 9/7/2018 there are 268 unused Cat_No from 1 to 1214
...
# As of 9/7/2018 there are 0 duplicated Cat_No
...
# As of 9/7/2018 all datasets have the same Cat_No

# de-Identify Data Except for Medical Record Number
colnames(Demdata)
Demdata.delete = -c(1:4,6:10,14:19,25:42)
...
write.csv(DEID.Master, "DEID_All7.csv")
write.csv(DEID.Demdata, "DEID_Demographics7.csv")
write.csv(DEID.MedHisdata, "DEID_Medical_History7.csv")
write.csv(DEID.Mesdata, "DEID_Measurements7.csv")
