...
#         into new csv files; 4th round of data received                           #
####################################################################################

# upload data
Demdata=read.csv("qry_TBL_Demographics_1to478plusDeceasedfromCAT478Extract7182017.csv")
Mesdata=read.csv("qry_TBL_Measurement_1to478plusDeceasedfromCAT478Extract7182017.csv")
MedHisdata=read.csv("qry_TBLMedHist_1to478plusDeceasedfromCAT478Extract7182017.csv")
...
New.MedHisdata = MedHisdata[, c(-1, -4:-8, -64:-69)]
...
write.csv(DEID.Master, "DEID_All4.csv")
write.csv(DEID.Demdata, "DEID_Demographics4.csv")
write.csv(DEID.MedHisdata, "DEID_Medical_History4.csv")
write.csv(DEID.Mesdata, "DEID_Measurements4.csv")
