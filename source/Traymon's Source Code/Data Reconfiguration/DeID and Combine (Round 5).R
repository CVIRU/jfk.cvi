...
# upload data
Demdata = read.csv("qry_TBL_Demog_1to638plusDeceasedfromCAT638Extract912017.csv")
Mesdata = read.csv("qry_TBL_Measurement_1to638plusDeceasedfromCAT638Extract9012017.csv")
MedHisdata = read.csv("qry_TBLMedHist_1to638plusDeceasedfromCAT638Extract9012017.csv")
...
write.csv(DEID.Master, "DEID_All5.csv")
write.csv(DEID.Demdata, "DEID_Demographics5.csv")
write.csv(DEID.MedHisdata, "DEID_Medical_History5.csv")
write.csv(DEID.Mesdata, "DEID_Measurements5.csv")
