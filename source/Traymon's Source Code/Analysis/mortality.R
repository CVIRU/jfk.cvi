...
for (i in 1:3){
  ...
  if (i != 3){
    ...
    for (j in 1:length(cat.list[[i]])){
      ...
      print(sum(match.subgroup.One[match.subgroup.One[, cat.name.list[i]] == cat.list[[i]][j] , "Deceased_Y.N"]))
      
      print(mean(match.subgroup.One[match.subgroup.One[, cat.name.list[i]] == cat.list[[i]][j] , "Deceased_Y.N"]))
    ...
    for (j in 1:6){
      ...
      print(sum(match.subgroup.One[match.subgroup.One[, cat.name.list[i]] >= cat.list[[i]][j] &
                               match.subgroup.One[, cat.name.list[i]] <= cat.list[[i]][j+6], "Deceased_Y.N"]))
      
      print(mean(match.subgroup.One[match.subgroup.One[, cat.name.list[i]] >= cat.list[[i]][j] &
                                     match.subgroup.One[, cat.name.list[i]] <= cat.list[[i]][j+6], "Deceased_Y.N"]))
...
sum(match.subgroup.One[, "Deceased_Y.N"])
...
cut.data = mortality.data[mortality.data[, "Survival.Time"] < long.last +1, "Survival.Time"]

cut.data = cut.data[order(cut.data)]
