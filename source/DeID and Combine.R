...
###Create new ID variable based on the order of the data after sorting medical record number
...
###Reorder variables so that ID is the first variable
...
#find the first occurences in Measurement dataset for each patient
...
#bind each patient to their respective measurements
T=1
